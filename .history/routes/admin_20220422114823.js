...
router.get("/pontos", (req, res) => {
    ...
    Ponto.find().then((pontos) => {
        ...
        function obterRegistroPorUsuario(pontosid, id) {
            console.log(Ponto.id + "- " + id)
            return pontosid.filter((ponto) => ponto.id === id)
        ...
        function obterPonto(pontos, incremento, tipo) {
            const ponto = pontos.find((ponto) => (ponto === nu ll || ponto === void 0 ? void 0 : ponto.incremento) === incremento && tipo === (ponto == null || ponto === void 0 ? void 0 : ponto.tipo))
        }
