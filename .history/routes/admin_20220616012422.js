...
router.get("/pontos", (req, res) => {
    ...
    Ponto.find().then((pontos) => {
        ...
        function obterPonto(pontos, tipo) {
            const ponto = pontos.find((ponto) => (ponto === null || ponto === void 0) && tipo === (ponto == null || ponto === void 0 ? void 0 : ponto.tipo))
            //console.log(ponto)
            return ponto
        }
            ...
            while (idsUnico[indice]) {
                ...
                while (registrosDoUsuario[indiceDois]) {
                 ...
                 //   const proximoIncremento = registrosDoUsuario[indiceDois].incremento + 1;
                    ...
                    const tipoSaida = '1';
                    const par = 2;
                    const entrada = obterPonto(pontos, tipoEntrada);
                    const saida = obterPonto(pontos, tipoSaida);
