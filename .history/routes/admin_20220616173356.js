...
router.get("/pontos", (req, res) => {
    ...
    Ponto.find().then((pontos) => {
        ...
        function obterPonto(pontos, id, tipo, matricula) {
            const ponto = pontos.find((ponto) => (ponto === null || ponto === void 0 ? void 0 : ponto.id) === id && tipo === (ponto == null || ponto === void 0 ? void 0 : ponto.tipo) && matricula === (ponto == null || ponto === void 0 ? void 0 : matricula.matricula))
            console.log(ponto)
            return ponto
        }
