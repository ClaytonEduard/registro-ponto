...
const collet = require('collet.js')
...
router.get("/pontos", (req, res) => {
    ...
    Ponto.find().then((pontos) => {
        ...
        (let i = 0; i < pegar.length; i++) {
            ...
            // if (pegar[i]) {} else {
            //      out.push(pegar[i].datalancamento.toString('DD/MM/AAAA - HH:MM:SS.ssZ'))
            //  }
        ...
        ar pontoFiltrado = pontos.map((item, indice) => {
            rn {
