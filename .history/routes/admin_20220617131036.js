        ...
        function obterRelatorio(pontos) {
            ...
            while (idsUnico[indice]) {
                ...
                while (registrosDoUsuario[indiceDois]) {
                    ...
                    const proximoMatricula = registrosDoUsuario[indiceDois].matricula + 1
                    const tipoEntrada = '0';
                    const tipoSaida = '1';
                    const par = 2;
                    const entrada = obterPonto(pontos, idAtual, tipoEntrada, matriculaAtual);
                    const saida = obterPonto(pontos, proximoId, tipoSaida, proximoMatricula);
                    console.log("Entrada :" + JSON.stringify(entrada))
                    console.log("----")
                    console.log("Saida :" + JSON.stringify(entrada))
