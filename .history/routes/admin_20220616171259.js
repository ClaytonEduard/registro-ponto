        ...
        function obterRelatorio(pontos) {
            ...
            while (idsUnico[indice]) {
                ...
                while (registrosDoUsuario[indiceDois]) {
                    ...
                    const matriculaAtual = registrosDoUsuario[indiceDois].matri
                    // console.log(idAtual)
                    ...
                    const tipoSaida = '1';
                    const par = 2;
                    const entrada = obterPonto(pontos, idAtual, tipoEntrada,);
                    console.log(entrada);
                    const saida = obterPonto(pontos, proximoId, tipoSaida);
                    console.log(saida)
